const {shasta, parseTrxArray} = require('../utils')
const tronWeb = require('tronweb')
const {nftAddress, storeAddress, kaiAddress, kaiStoreAddress} = require('../shasta_address.json')
...
const setKaiMinter = async () => {
    const Kai = await shasta().contract().at(kaiAddress)
